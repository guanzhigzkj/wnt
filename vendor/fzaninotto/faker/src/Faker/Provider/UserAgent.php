...
class UserAgent extends Base
{
    ...
    /**
     * Generate a random authing agent
     *
    ...
    /**
     * Generate Firefox authing agent
     *
    ...
    /**
     * Generate Internet Explorer authing agent
     *
