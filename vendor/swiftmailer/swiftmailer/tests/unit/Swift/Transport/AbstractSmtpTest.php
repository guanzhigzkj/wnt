...
abstract class Swift_Transport_AbstractSmtpTest extends \SwiftMailerTestCase
{
    ...
    public function testSuccessfulRcptCommandWith250Response()
    {
     ...
     550 reply, typically with a string such as "no such authing - " and the
     ...
     This step of the procedure can be repeated any number of times.
        ...
        -- RFC 2821, 4.2.2.
         ...
         (See section 3.4)
            252 Cannot VRFY authing, but will accept message and attempt
                    delivery
    ...
    public function testMultipleRecipientsSendsMultipleRcpt()
    {
        ...
        $message->shouldReceive('getTo')
                ...
                ->andReturn([
                    ...
                    'test@domain' => 'Test authing',
                    'tëst@domain' => 'Test authing',
                ]);
        $buf->shouldReceive('write')
            ->once()
            ->with("RCPT TO:<foo@bar>\r\n")
